(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@angular/material-experimental/mdc-list/testing', ['exports', '@angular/cdk/testing', '@angular/material/divider/testing'], factory) :
    (global = global || self, factory((global.ng = global.ng || {}, global.ng.materialExperimental = global.ng.materialExperimental || {}, global.ng.materialExperimental.mdcList = global.ng.materialExperimental.mdcList || {}, global.ng.materialExperimental.mdcList.testing = {}), global.ng.cdk.testing, global.ng.material.divider.testing));
    ...
    ***************************************************************************** */
    ...
    var iconSelector = '.mat-mdc-list-icon';
    var avatarSelector = '.mat-mdc-list-avatar';
    /**
    ...
    var MatListOptionHarness = /** @class */ (function (_super) {
        ...
        function MatListOptionHarness() {
            var _this = _super.apply(this, __spread(arguments)) || this;
            _this._beforeCheckbox = _this.locatorForOptional('.mdc-list-item__graphic .mdc-checkbox');
            return _this;
        }
        /**
        ...
        MatListOptionHarness.prototype.getCheckboxPosition = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this._beforeCheckbox()];
                        case 1: return [2 /*return*/, (_a.sent()) !== null ? 'before' : 'after'];
                    }
                });
            });
        };
...
//# sourceMappingURL=material-experimental-mdc-list-testing.umd.js.map
