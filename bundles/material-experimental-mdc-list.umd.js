(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/cdk/coercion'), require('@angular/cdk/platform'), require('@angular/material-experimental/mdc-core'), require('@angular/platform-browser/animations'), require('@material/ripple'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@angular/material/divider'), require('@angular/cdk/collections'), require('@angular/forms'), require('@material/list'), require('@angular/material/list')) :
    typeof define === 'function' && define.amd ? define('@angular/material-experimental/mdc-list', ['exports', '@angular/core', '@angular/cdk/coercion', '@angular/cdk/platform', '@angular/material-experimental/mdc-core', '@angular/platform-browser/animations', '@material/ripple', 'rxjs', 'rxjs/operators', '@angular/common', '@angular/material/divider', '@angular/cdk/collections', '@angular/forms', '@material/list', '@angular/material/list'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.ng = global.ng || {}, global.ng.materialExperimental = global.ng.materialExperimental || {}, global.ng.materialExperimental.mdcList = {}), global.ng.core, global.ng.cdk.coercion, global.ng.cdk.platform, global.ng.materialExperimental.mdcCore, global.ng.platformBrowser.animations, global.mdc.ripple, global.rxjs, global.rxjs.operators, global.ng.common, global.ng.material.divider, global.ng.cdk.collections, global.ng.forms, global.mdc.list, global.ng.material.list));
}(this, (function (exports, core, coercion, platform, mdcCore, animations, ripple, rxjs, operators, common, divider, collections, forms, list$1, list) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var MatListItemBase = /** @class */ (function () {
        function MatListItemBase(_elementRef, _ngZone, _listBase, _platform, globalRippleOptions, animationMode) {
        ...
        MatListItemBase.prototype._monitorLines = function () {
            ...
            this._ngZone.runOutsideAngular(function () {
                _this._subscriptions.add(_this.lines.changes.pipe(operators.startWith(_this.lines))
                    ...
                    toggleClass(_this._hostElement, 'mdc-list-item--with-one-line', lines.length <= 1);
                    lines.forEach(function (line, index) {
                        toggleClass(_this._hostElement, 'mdc-list-item--with-two-lines', lines.length === 2);
                        toggleClass(_this._hostElement, 'mdc-list-item--with-three-lines', lines.length === 3);
    ...
    var MatListItem = /** @class */ (function (_super) {
        ...
        function MatListItem(element, ngZone, listBase, platform, globalRippleOptions, animationMode) {
            return _super.call(this, element, ngZone, listBase, platform, globalRippleOptions, animationMode) || this;
        }
        return MatListItem;
    }(MatListItemBase));
    ...
    var MatListOption = /** @class */ (function (_super) {
        ...
        function MatListOption(element, ngZone, platform, _selectionList, _changeDetectorRef, globalRippleOptions, animationMode) {
            var _this = _super.call(this, element, ngZone, _selectionList, platform, globalRippleOptions, animationMode) || this;
        ...
        MatListOption.prototype._hasCheckboxAt = function (position) {
            return this._selectionList.multiple && this._getCheckboxPosition() === position;
        };
        /** Whether icons or avatars are shown at the given position. */
        MatListOption.prototype._hasIconsOrAvatarsAt = function (position) {
            return this._hasProjected('icons', position) || this._hasProjected('avatars', position);
        };
        /** Gets whether the given type of element is projected at the specified position. */
        MatListOption.prototype._hasProjected = function (type, position) {
