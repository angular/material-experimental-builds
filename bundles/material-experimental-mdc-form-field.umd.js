(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var MatFormField = /** @class */ (function () {
        ...
        MatFormField.prototype._checkPrefixAndSuffixTypes = function () {
            this._hasIconPrefix = !!this._prefixChildren.find(function (p) { return !p._isText; });
            this._hasTextPrefix = !!this._prefixChildren.find(function (p) { return p._isText; });
            this._hasIconSuffix = !!this._suffixChildren.find(function (s) { return !s._isText; });
            this._hasTextSuffix = !!this._suffixChildren.find(function (s) { return s._isText; });
        };
        ...
        MatFormField.prototype._initializePrefixAndSuffix = function () {
            ...
            rxjs.merge(this._prefixChildren.changes, this._suffixChildren.changes)
                .subscribe(function () {
                _this._checkPrefixAndSuffixTypes();
                _this._changeDetectorRef.markForCheck();
            });
        };
        /**
        ...
        MatFormField.prototype._updateOutlineLabelOffset = function () {
            ...
            var iconPrefixContainer = (_a = this._iconPrefixContainer) === null || _a === void 0 ? void 0 : _a.nativeElement;
            var textPrefixContainer = (_b = this._textPrefixContainer) === null || _b === void 0 ? void 0 : _b.nativeElement;
            // If the directionality is RTL, the x-axis transform needs to be inverted. This
            // is because `transformX` does not change based on the page directionality.
            var labelHorizontalOffset = (this._dir.value === 'rtl' ? -1 : 1) * ((iconPrefixContainer ?
                // If there's an icon prefix, we disable the default 16px padding,
                // so make sure to account for that.
                ((_c = iconPrefixContainer === null || iconPrefixContainer === void 0 ? void 0 : iconPrefixContainer.getBoundingClientRect().width) !== null && _c !== void 0 ? _c : 0) - 16 : 0) +
                ((_d = textPrefixContainer === null || textPrefixContainer === void 0 ? void 0 : textPrefixContainer.getBoundingClientRect().width) !== null && _d !== void 0 ? _d : 0));
    ...
    MatFormField.propDecorators = {
        ...
        _iconPrefixContainer: [{ type: core.ViewChild, args: ['iconPrefixContainer',] }],
        _textPrefixContainer: [{ type: core.ViewChild, args: ['textPrefixContainer',] }],
