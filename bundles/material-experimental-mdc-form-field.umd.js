    ...
    ***************************************************************************** */
    ...
    var MatFormField = /** @class */ (function () {
        ...
        MatFormField.prototype._updateOutlineLabelOffset = function () {
            ...
            var iconPrefixContainer = this._iconPrefixContainer.nativeElement;
            var textPrefixContainer = this._textPrefixContainer.nativeElement;
            // If the directionality is RTL, the x-axis transform needs to be inverted. This
            // is because `transformX` does not change based on the page directionality.
            var labelHorizontalOffset = (this._dir.value === 'rtl' ? -1 : 1) * (iconPrefixContainer.getBoundingClientRect().width +
