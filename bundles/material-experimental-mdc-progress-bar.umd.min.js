!function(r,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports,require("@angular/core"),require("@angular/material-experimental/mdc-core"),require("@angular/platform-browser/animations"),require("@material/linear-progress"),require("rxjs"),require("rxjs/operators"),require("@angular/cdk/bidi"),require("@angular/material/progress-bar")):"function"==typeof define&&define.amd?define("@angular/material-experimental/mdc-progress-bar",["exports","@angular/core","@angular/material-experimental/mdc-core","@angular/platform-browser/animations","@material/linear-progress","rxjs","rxjs/operators","@angular/cdk/bidi","@angular/material/progress-bar"],e):e(((r="undefined"!=typeof globalThis?globalThis:r||self).ng=r.ng||{},r.ng.materialExperimental=r.ng.materialExperimental||{},r.ng.materialExperimental.mdcProgressBar={}),r.ng.core,r.ng.materialExperimental.mdcCore,r.ng.platformBrowser.animations,r.mdc.linearProgress,r.rxjs,r.rxjs.operators,r.ng.cdk.bidi,r.ng.material.progressBar)}(this,(function(r,e,n,a,t,i,o,s,m){"use strict";
/*! *****************************************************************************
    ...
    ***************************************************************************** */var l,c=function(r,e){return(c=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,e){r.__proto__=e}||function(r,e){for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(r[n]=e[n])})(r,e)},d=function(r){function n(n,a,t,o){var s=r.call(this,n)||this;return s._elementRef=n,s._ngZone=a,s._dir=t,s._animationMode=o,s._adapter={addClass:function(r){return s._rootElement.classList.add(r)},forceLayout:function(){return s._rootElement.offsetWidth},removeAttribute:function(r){return s._rootElement.removeAttribute(r)},setAttribute:function(r,e){return s._rootElement.setAttribute(r,e)},hasClass:function(r){return s._rootElement.classList.contains(r)},removeClass:function(r){return s._rootElement.classList.remove(r)},setPrimaryBarStyle:function(r,e){s._primaryBar.style[r]=e},setBufferBarStyle:function(r,e){s._bufferBar.style[r]=e},setStyle:function(r,e){s._rootElement.style[r]=e},getWidth:function(){return s._rootElement.offsetWidth},attachResizeObserver:function(r){var e="undefined"!=typeof window&&window.ResizeObserver;return e?s._ngZone.runOutsideAngular((function(){var n=new e(r);return"function"==typeof n.observe?(n.observe(s._rootElement),n):null})):null}},s._isNoopAnimation=!1,s._value=0,s._bufferValue=0,s.animationEnd=new e.EventEmitter,s._animationEndSubscription=i.Subscription.EMPTY,s._dirChangeSubscription=i.Subscription.EMPTY,s._mode="determinate",s._isNoopAnimation="NoopAnimations"===o,t&&(s._dirChangeSubscription=t.change.subscribe((function(){return s._syncFoundation()}))),s}return function a(r,e){if("function"!=typeof e&&null!==e)throw new TypeError("Class extends value "+String(e)+" is not a constructor or null");function n(){this.constructor=r}c(r,e),r.prototype=null===e?Object.create(e):(n.prototype=e.prototype,new n)}(n,r),Object.defineProperty(n.prototype,"value",{get:function(){return this._value},set:function(r){this._value=u(r||0),this._syncFoundation()},enumerable:!1,configurable:!0}),Object.defineProperty(n.prototype,"bufferValue",{get:function(){return this._bufferValue||0},set:function(r){this._bufferValue=u(r||0),this._syncFoundation()},enumerable:!1,configurable:!0}),Object.defineProperty(n.prototype,"mode",{get:function(){return this._mode},set:function(r){this._mode=r,this._syncFoundation()},enumerable:!1,configurable:!0}),n.prototype.ngAfterViewInit=function(){var r=this,e=this._elementRef.nativeElement;this._rootElement=e.querySelector(".mdc-linear-progress"),this._primaryBar=e.querySelector(".mdc-linear-progress__primary-bar"),this._bufferBar=e.querySelector(".mdc-linear-progress__buffer-bar"),this._foundation=new t.MDCLinearProgressFoundation(this._adapter),this._foundation.init(),this._syncFoundation(),this._ngZone.runOutsideAngular((function(){r._animationEndSubscription=i.fromEvent(r._primaryBar,"transitionend").pipe(o.filter((function(e){return e.target===r._primaryBar}))).subscribe((function(){"determinate"!==r.mode&&"buffer"!==r.mode||r._ngZone.run((function(){return r.animationEnd.next({value:r.value})}))}))}))},n.prototype.ngOnDestroy=function(){this._foundation&&this._foundation.destroy(),this._animationEndSubscription.unsubscribe(),this._dirChangeSubscription.unsubscribe()},n.prototype._syncFoundation=function(){var r=this._foundation;if(r){var e=this.mode,n=("rtl"===(this._dir?this._dir.value:"ltr")?"query"!==e:"query"===e)?"rtl":"ltr";this._rootElement.getAttribute("dir")!==n&&(this._rootElement.setAttribute("dir",n),r.restartAnimation()),r.setDeterminate("indeterminate"!==e&&"query"!==e),r.setProgress(this.value/100),"buffer"===e&&r.setBuffer(this.bufferValue/100)}},n}(n.mixinColor((function p(r){this._elementRef=r}),"primary"));function u(r,e,n){return void 0===e&&(e=0),void 0===n&&(n=100),Math.max(e,Math.min(n,r))}
/**
     * @license
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Object.defineProperty(r,"MAT_PROGRESS_BAR_LOCATION",{enumerable:!0,get:function(){return m.MAT_PROGRESS_BAR_LOCATION}}),Object.defineProperty(r,"MAT_PROGRESS_BAR_LOCATION_FACTORY",{enumerable:!0,get:function(){return m.MAT_PROGRESS_BAR_LOCATION_FACTORY}}),r.MatProgressBar=d,r.MatProgressBarModule=l,Object.defineProperty(r,"__esModule",{value:!0})}));