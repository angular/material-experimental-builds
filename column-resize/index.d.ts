...
export declare class MatColumnResize extends AbstractMatColumnResize {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatColumnResize, "table[mat-table][columnResize]", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatColumnResizeFlex extends AbstractMatColumnResize {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatColumnResizeFlex, "mat-table[columnResize]", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatColumnResizeOverlayHandle extends ResizeOverlayHandle {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MatColumnResizeOverlayHandle, "ng-component", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatDefaultEnabledColumnResize extends AbstractMatColumnResize {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatDefaultEnabledColumnResize, "table[mat-table]", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatDefaultEnabledColumnResizeFlex extends AbstractMatColumnResize {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatDefaultEnabledColumnResizeFlex, "mat-table", never, {}, {}, never, never, false, never, false>;
}
...
export declare class MatDefaultResizable extends AbstractMatResizable {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatDefaultResizable, "mat-header-cell:not([disableResize]), th[mat-header-cell]:not([disableResize])", never, { "minWidthPx": { "alias": "matResizableMinWidthPx"; "required": false; }; "maxWidthPx": { "alias": "matResizableMaxWidthPx"; "required": false; }; }, {}, never, never, false, never, false>;
}
...
export declare class MatResizable extends AbstractMatResizable {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MatResizable, "mat-header-cell[resizable], th[mat-header-cell][resizable]", never, { "minWidthPx": { "alias": "matResizableMinWidthPx"; "required": false; }; "maxWidthPx": { "alias": "matResizableMaxWidthPx"; "required": false; }; }, {}, never, never, false, never, false>;
}
