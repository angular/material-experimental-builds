...
class MatFormField {
    ...
    _updateOutlineLabelOffset() {
        ...
        const labelHorizontalOffset = (this._dir.value === 'rtl' ? -1 : 1) * ((iconPrefixContainer ?
...
MatFormField.propDecorators = {
    ...
    _iconPrefixContainer: [{ type: ViewChild, args: ['iconPrefixContainer',] }],
    _textPrefixContainer: [{ type: ViewChild, args: ['textPrefixContainer',] }],
