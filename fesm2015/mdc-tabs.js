...
import { Directive, Inject, forwardRef, ComponentFactoryResolver, ViewContainerRef, ViewChild, Component, ViewEncapsulation, ChangeDetectionStrategy, Optional, ElementRef, ChangeDetectorRef, Input, ContentChild, TemplateRef, ContentChildren, QueryList, NgZone, Attribute, NgModule } from '@angular/core';
...
let MatTabBodyPortal = /** @class */ (() => {
    let MatTabBodyPortal = class MatTabBodyPortal extends MatTabBodyPortal$1 {
...
let MatTabContent = /** @class */ (() => {
    let MatTabContent = class MatTabContent extends MatTabContent$1 {
    };
...
let MatTabLabel = /** @class */ (() => {
    let MatTabLabel = class MatTabLabel extends MatTabLabel$1 {
    };
...
let MatTabLabelWrapper = /** @class */ (() => {
    let MatTabLabelWrapper = class MatTabLabelWrapper extends MatTabLabelWrapper$1 {
 ...
 */
let MatTab = /** @class */ (() => {
    let MatTab = class MatTab extends MatTab$1 {
    };
    __decorate([
