...
import { Component, ChangeDetectionStrategy, ViewEncapsulation, Inject, ElementRef, NgZone, NgModule } from '@angular/core';
...
let MatMenu = /** @class */ (() => {
    var MatMenu_1;
    let MatMenu = MatMenu_1 = class MatMenu extends MatMenu$1 {
    ...
    MatMenu = MatMenu_1 = __decorate([
        Component({
            ...
            providers: [
                ...
                { provide: MatMenu$1, useExisting: MatMenu_1 },
            ],
...
let MatMenuItem = /** @class */ (() => {
    var MatMenuItem_1;
    let MatMenuItem = MatMenuItem_1 = class MatMenuItem extends MatMenuItem$1 {
    };
    MatMenuItem = MatMenuItem_1 = __decorate([
        Component({
            ...
            providers: [
                { provide: MatMenuItem$1, useExisting: MatMenuItem_1 },
            ]
        })
    ], MatMenuItem);
    return MatMenuItem;
