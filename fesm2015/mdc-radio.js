...
import { forwardRef, ContentChildren, QueryList, Directive, Component, ViewEncapsulation, ChangeDetectionStrategy, Optional, Inject, ElementRef, ChangeDetectorRef, NgModule } from '@angular/core';
...
let MatRadioGroup = /** @class */ (() => {
    let MatRadioGroup = class MatRadioGroup extends MatRadioGroup$1 {
    };
    __decorate([
